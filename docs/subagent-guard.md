...
A home is in scope when it has `AGENTS.md`, a `bin/` directory, an existing state directory, and a plain checkout where git-dir equals git-common-dir.
