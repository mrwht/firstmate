...
Only a plain, non-worktree checkout is in scope: the git-dir check keeps crewmate and scout linked worktrees inert because their git dir differs from their git common dir.
