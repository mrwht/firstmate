...
family_for_basename() {
  case "$1" in
    ...
    fm-control-herdr-smoke.test.sh|fm-herdr-validation-attach-smoke.test.sh)
      printf '%s\n' real-herdr-gated
      ;;
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-primary-scope-lib.sh|bin/fm-project-mode.sh|bin/fm-task-mode.sh|bin/fm-promote.sh|\
