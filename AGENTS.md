...
config/secondmate-harness.<id>  optional per-secondmate override, same grammar and fallback chain as config/secondmate-harness (docs/configuration.md "Harness support"); LOCAL, gitignored; not inherited
